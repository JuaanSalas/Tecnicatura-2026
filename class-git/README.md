...
Abrimos terminal de GitBash

pwd  #Vemos la ruta de la carpeta en la que estamos

cd #Es para navegar a una carpeta: change directory -> cambiar de directorio

cd / #Nos llava al home, en la raiz del disco

cd ~ #La virgulilla significa que estamos en el lugar de los documentos o del usuario

ls #Esto es listar los archivos, nos muestra todos los archivos en la raiz
...
mkdir Tecnicatura #Recordar que en window las mayusculas no tienen relevancia, pero si en Linux
...
touch vacio.txt #Crea un archivo con su extencion: ESCRIBIR DENTRO
...
!72 + enter #Veremos el comando que utilizamos en ese numero
...
Crear repositorio de git y hacer el primer commit
...
NOTA: SI EL REPOSITORIO YA ESTA CREADO NO EJECUTAR ESTOS COMANDOS
...
git status #Vemos el estado del proyecto en tiempo real, esta en el area de trabajo

git add historia.txt #Enviamos el archivo al area de preparacion

git status #Para ver el estado de cambios

git rm --cached historia.txt #Quitamos el archivo del area de preparacion, cached significa que esta en memoria ram

git config #Tedremos la lista de como funciona la configuracion

git config --list #Configuraciones por defecto, faltan cosas importantes

git config --list --show-origin #Veremos donde estan las configuraciones guardadas

NOTA: SI LAS CONFIGURACIONES YA ESTAN HECHAS NO DEBEN HACERSE DE NUEVO

git config --global user.name "Ariel Betancud"

git config --global user.email "miCorreo" #El correo debe ser el mismo que usaremos en GitHub

git config --list #Ahora veremos que ya estan todos los datos completos

git add . #Ingresamos todos los archivos al area de preparacion (ram)
...
git log historia.txt #Vemos toda la historia de este archivo, el numero largo es el hash del commit

## Clase 3

cd tecnicaturagit #Ingresamos al direcotorio donde estan nuestras carpetas de trabajo
...
rm historia.txt #Eliminamos el archivo que habiamos hecho, esto en git bash (window) esto es para practica
...
rm --help #Nos muestra lo que les puse arriba como documentacion en Ingles.
...
Enlace a la documentacion en GitHub de [MARKDOWN](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax#relative-links)

Leemos la documentacion para ir creando en README.md como lo ensenia GitHub.
...
cd tecnicatura #Entramos en el repositorio

cd class-git #Entramos en la carpeta class-git

ls #Vemos los archivos dentro de la carpeta

touch historia.txt #Creamos un archivo de texto txt
...
ssh-keygen -t rsa -b 4096 -C "miMail"
...
´´´sh
    cd Documents (o la carpeta donde se quiera clonar el repo)
    mkdir #Nombre del proyecto
    cd # Nombre del protecto
    git clone # Colocamos el enlace ssh
    cd # Nombre del repositorio remoto
    git pull origin main
    git fetch
    git branch # Estara en la rama main por defecto
    touch README.md # Esto es si no creamos el readme en el remoto
    git status
    git add .
    git commit -m "Creamos el reamde.md"
    git status
