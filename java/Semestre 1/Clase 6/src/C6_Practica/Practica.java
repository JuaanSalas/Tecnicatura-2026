...
public class Practica {
    public static void main(String[] args) {
        ...
        */
        ...
        // Tipos prmimitivos booleanos
        boolean varBool = true; // true y false con minusculas
        ...
        var edad = 30; // var, inferencia de tipos
        //var edadAdulto = edad >=18; // Expresion booleana
        if (edad >= 18){
        ...
        var edad2 = Integer.parseInt("20");// Convierte dato de tipo str a tipo int
        System.out.println("edad2 = " + (edad2 + 1));
        var valorPi = Double.parseDouble("3.1416"); // Convierte a tipo double
